...
var ValueReaction = (function (_super) {
    ...
    function ValueReaction(props) {
        ...
        _this.scheduleVelocityCheck = function () {
            sync__default.postRender(_this.velocityCheck);
        };
    ...
    return action(function (_a) {
        ...
        var process = sync__default.update(function (_a) {
            ...
            if (springStrength !== undefined && to !== undefined) {
                ...
                velocity +=
                    distanceToTarget * popcorn.velocityPerFrame(springStrength, elapsed);
            }
...
var styler = function () {
    return heyListen.invariant(false, 'styler has been removed from Popmotion in 9.0. Downgrade to 8.x or npm install stylefire');
};
